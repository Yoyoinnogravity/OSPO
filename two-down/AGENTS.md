...
4. Model: Claude Sonnet (Anthropic). Do not pick Grok. Other Models pool — this is the quality pick Aled locked.
...
3. If it built a new pair:
   ...
   - Open or update a PR onto main titled like: Cryptic Fun · {date}
